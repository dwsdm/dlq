...
import com.dailywisdom.app.MainActivity
import com.dailywisdom.app.R
...
class NotificationReceiver : BroadcastReceiver() {
    ...
    private fun showNotification(context: Context, quote: Quote?) {
        ...
        val quoteOfDayIntent = Intent(context, com.dailywisdom.app.QuoteOfDayActivity::class.java).apply {
            flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
        }
