package com.dailywisdom.app.ads
...
class AdManager private constructor(private val context: Context) {
    ...
    companion object {
        ...
        private const val BANNER_AD_UNIT_ID = "ca-app-pub-3459996192536925/8231179933" // 2025 Production ID
        private const val REWARDED_AD_UNIT_ID = "ca-app-pub-3459996192536925/2978853253" // 2025 Production ID
        // Test ad unit ID for banner ads
        private const val TEST_BANNER_AD_UNIT_ID = "ca-app-pub-3459996192536925/8231179933" // Always use this for testing
        // Test ad unit ID for rewarded ads
        private const val TEST_REWARDED_AD_UNIT_ID = "ca-app-pub-3459996192536925/2978853253" // Always use this for testing
        // Test ad unit ID for interstitial ads
        private const val TEST_INTERSTITIAL_AD_UNIT_ID = "ca-app-pub-3459996192536925/9866635746" // Always use this for testing
    ...
    fun loadBannerAd(adContainer: ViewGroup) {
        try {
            ...
            adView.adUnitId = TEST_BANNER_AD_UNIT_ID // Use test ad ID for development
            ...
            Log.d(TAG, "Banner ad loading with test ID: $TEST_BANNER_AD_UNIT_ID")
        } catch (e: Exception) {
    ...
    fun loadInterstitialAd() {
        ...
        try {
            val adRequest = AdRequest.Builder().build()
            InterstitialAd.load(context, TEST_INTERSTITIAL_AD_UNIT_ID, adRequest, object : InterstitialAdLoadCallback() {
